...
class WaitStrategiesTest extends TestCase
{
    ...
    public function testFixedWaitMinimumAtLeastZero()
    {
    ...
    public function testRandomWaitMaximumGreaterThanMinimum()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testRandomWaitMinimumAtLeastZero()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testRandomWait()
    {
        $attempt = \Mockery::mock(Attempt::class);
    ...
    public function testExponentialValidationMultiplierLessThanMaximumWait()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testExponentialValidationMaximumWaitLessThanZero()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testExponentialValidationMultiplierZero()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testFibonacciValidationMultiplierLessThanMaximumWait()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('$multiplier must be less than $maximumWait but $multiplier is 1 and $maximumWait is 1');
    ...
    public function testFibonacciValidationMaximumWaitLessThanZero()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('$maximumWait must be greater than or equal to 0');
    ...
    public function testFibonacciValidationMultiplierZero()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('$multiplier must be greater than 0');
    ...
    public function testExceptionWaitValidation()
    {
        $this->expectException(\InvalidArgumentException::class);
    ...
    public function testExceptionWait()
    {
    ...
    public function testExceptionWaitZero()
    {
        $exceptionHandler = fn(\RuntimeException $e) => 1;
